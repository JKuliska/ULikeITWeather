...
public class TodayFragment extends WeatherParentFragment {
    ...
    public void renderView()
    {
        ...
        mText[0].setText(weather.getHumidity() + getActivity().getResources().getString(R.string.global_percent_abbr));
        mImg[1].setImageResource(R.drawable.ic_precipitation);
        mText[1].setText(weather.getPrecip() + getActivity().getResources().getString(R.string.global_milimeter_abbr));
        mImg[2].setImageResource(R.drawable.ic_pressure);
        mText[2].setText(weather.getPressure() + getActivity().getResources().getString(R.string.global_hpa_abbr));
        mImg[3].setImageResource(R.drawable.ic_wind_speed);
        mText[3].setText(prefs.isKilometer() ? weather.getWindSpeedKmh() + getActivity().getResources().getString(R.string.global_kph_abbr)
                : weather.getWindSpeedMph() + getActivity().getResources().getString(R.string.global_mph_abbr));
        mImg[4].setImageResource(R.drawable.ic_wind_direction);
        mText[4].setText(weather.getWindDir());

        TextView mDescriptionTxt = (TextView) getActivity().findViewById(R.id.txt_temperature);
        mDescriptionTxt.setText((prefs.isCelsius() ? weather.getTempC() + getActivity().getResources().getString(R.string.global_celsius_abbr)
